...
Model::Model(ID3D11Device* dev, Model::PreMadedeModels pm)
{
	mDevice = dev;
	pStdVerts = nullptr;
	pTriList = nullptr;
	...
	{
	case BigPlane:
		ModelTools::CreatePlane(9, 9, pStdVerts, numVerts, pTriList, numTris, 500.0f);
		break;
	case UnitPlane:
		ModelTools::CreatePlane(9, 9, pStdVerts, numVerts, pTriList, numTris, 20.0f);
		break;
	case UnitBox:
		ModelTools::CreateUnitBox(pStdVerts, numVerts, pTriList, numTris);
		break;
	case UnitBoxRepeatedTexture:
		ModelTools::CreateUnitBoxRepTexture(pStdVerts, numVerts, pTriList, numTris, 0.5f);
		break;
	case UnitBoxSixFaceTexture:
		ModelTools::CreateUnitBoxSixFaceTexture(pStdVerts, numVerts, pTriList, numTris, 0.5f);
		break;
	case SkyBox:
		ModelTools::CreateSkyBox(pStdVerts, numVerts, pTriList, numTris, 500);
		break;
	case BigPyramid:
		ModelTools::CreateBigPyramid(pStdVerts, numVerts, pTriList, numTris);
		break;
	case UnitPyramid:
...
Model::Model(ID3D11Device * dev, PreMadedeModels pm, float size)
{
	mDevice = dev;
	pStdVerts = nullptr;
	pTriList = nullptr;
	...
	{
	case BigPlane:
		ModelTools::CreatePlane(9, 9, pStdVerts, numVerts, pTriList, numTris, size);
		break;
	case UnitPlane:
		ModelTools::CreatePlane(9, 9, pStdVerts, numVerts, pTriList, numTris, size);
		break;
	case UnitBox:
		...
		break;
	case UnitBoxRepeatedTexture:
		ModelTools::CreateUnitBoxRepTexture(pStdVerts, numVerts, pTriList, numTris, size);
		break;
	case UnitBoxSixFaceTexture:
		ModelTools::CreateUnitBoxSixFaceTexture(pStdVerts, numVerts, pTriList, numTris,  size);
		break;
	case SkyBox:
		ModelTools::CreateSkyBox(pStdVerts, numVerts, pTriList, numTris, size);
		break;
	case BigPyramid:
		ModelTools::CreateBigPyramid(pStdVerts, numVerts, pTriList, numTris);
		break;
