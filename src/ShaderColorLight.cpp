...
void ShaderColorLight::SetPointLightParameters(PointLight_ToShare PLIn[])
{
...
void ShaderColorLight::SetPointLightPos(int i, const Vect& pos)
{
	PointLightData[i].Position = pos;
}

void ShaderColorLight::SetPointLightParameters(int i, const Vect& pos, float r, const Vect& att, const Vect& amb, const Vect& dif, const Vect& sp)
{
...
void ShaderColorLight::SetSpotLightPos(const Vect& pos)
{
...
void ShaderColorLight::SetFogData(float FogStartIn, float FogRangeIn, Vect &FogColorIn)
{
	FogData fD;
